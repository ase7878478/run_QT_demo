...
#include <memory>
#include "../../run_QT_demo/EditorScene.h"
...
QT_MOC_LITERAL(2, 29, 0) // ""
    ...
    "EditorScene\0selectionChanged\0"
};
...
void EditorScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (EditorScene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorScene::selectionChanged)) {
                *result = 0;
                return;
            }
        }
